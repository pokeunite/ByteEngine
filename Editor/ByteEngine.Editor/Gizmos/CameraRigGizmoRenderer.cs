...
internal static class CameraRigGizmoRenderer
{
        ...
        Component? selectedComponent = null)
    {
        ...
        {
            /*
             * Unreal-style character facing indicator.
             *
             * The arrow is editor-only and follows the character root's real
             * Transform.Forward. That makes the engine's gameplay-facing
             * direction unambiguous while allowing the Visual child to keep a
             * source-model rotation correction.
             */
            CharacterController3D? character =
            ...
            CameraBoom3D? boom =
                gameObject.GetComponent<CameraBoom3D>();
                ...
                boom.Enabled)
            {
                ...
                PlayerController3D? controller =
                    gameObject.GetComponent<PlayerController3D>();

                float boomYaw =
                    boom.UseControlRotation &&
                    controller !=
                    null
            ...
            Camera3D? camera =
                gameObject.GetComponent<Camera3D>();
            ...
            if (arrowDirection.LengthSquared() >
                1f)
            {
                Vector2 direction =
                    Vector2.Normalize(
    ...
    private static void DrawCharacterForward(
        ImDrawListPtr draw,
        ...
        bool selected)
    {
        ...
        const float arrowHeadHalfWidth =
            7.0f;
